...
namespace WardrobeEnhancements.Behaviours
{
    public class Main : MonoBehaviour, IInitializable
    {
        ...
        public void Initialize()
        {
            ...
            var cityDoll = cosmeticsController.wardrobes[0].selfDoll;
            foreach (var wardrobe in cosmeticsController.wardrobes)
            {
                bool isCityLocation = wardrobe.selfDoll == cityDoll;
                ...
                var wardrobeCanvas = new GameObject("Wardrobe UI").AddComponent<Canvas>();
                ...
                Text CreateText(Font myFont, string myName)
                {
                    var text = new GameObject(myName).AddComponent<Text>();
                ...
                Text pageNameTxt = CreateText(outlinedFont, "Name"); pageNameTxt.text = "ILY LUNA"; // She's the best frfr
                ...
                Text pageTypeTxt = CreateText(outlinedFont, "Type"); pageTypeTxt.text = "CATEGORY";
                ...
                Text leftArrowTxt = CreateText(baseFont, "Left Arrow");
                ...
                Text rightArrowTxt = CreateText(baseFont,"Right Arrow");
                ...
                Text itemInfoTxt = CreateText(outlinedFont, "Info"); itemInfoTxt.text = "WELCOME TO\nGORILLA TAG!";
                ...
                Text itemSubInfoTxt = CreateText(outlinedFont,"Sub Info"); itemSubInfoTxt.text = "COST: 1000 | CATEGORY: HAT";
        ...
        public void FilterCosmetics(CosmeticsController cosmeticsController)
        {
            ...
            {
                if (!_wardrobePages[i].OverrideItems) goto AutomateList;
                switch (i)
                {
                    case 0:
                        ...
                        _storedArray[i] = standItems.Where(a => !cosmeticsController.unlockedCosmetics.Contains(a)).OrderBy(a => cosmeticsController.currentCart.Contains(a) ? 0 : 1).ToList();
                        continue;
                    case 1:
